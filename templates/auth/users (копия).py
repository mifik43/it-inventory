...
from templates.base.requirements import admin_required, login_required, permissions_required, permissions_required_all, permissions_required
...
@permissions_required_all([Permissions.users_read, Permissions.users_manage])
def users():
    db = get_db()
...
@permissions_required_all(Permissions.users_manage)
def create_user():
    db = get_db()
